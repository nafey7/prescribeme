          ...
          <div className="max-w-md">
            ...
            <div className="mb-8">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-2xl font-bold">PrescribeMe</span>
              </div>
            </div>
            ...
            <p className="text-lg text-blue-100 mb-8 leading-relaxed">
              The modern solution for healthcare providers to manage prescriptions efficiently,
              securely, and seamlessly. Join thousands of professionals who trust PrescribeMe.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-100">Instant synchronization across all devices</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="flex-shrink-0 w-6 h-6 bg-white/20 rounded-full flex items-center justify-center mt-1">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden mb-8 text-center">
            <div className="flex items-center justify-center space-x-3 mb-2">
              ...
              <span className="text-2xl font-bold text-gray-900">PrescribeMe</span>
            </div>
          </div>
