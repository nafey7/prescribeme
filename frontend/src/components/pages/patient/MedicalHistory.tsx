        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">{surgeries.length}</p>
            </div>
          </div>
        </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3">
                        ...
                        <Badge
                          variant={condition.status === 'active' ? 'info' : 'success'}
                        >
                          {condition.status}
                        </Badge>
                        <Badge
                      ...
                      <p className="mt-2 text-sm text-gray-600">
                        Diagnosed on{' '}
                        {new Date(condition.diagnosedDate).toLocaleDateString('en-US', {
                          year: 'numeric',
                          month: 'long',
                          day: 'numeric',
                        })}{' '}
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-2 grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900">{surgery.hospital}</p>
                        </div>
                        <div>
                          <p className="text-gray-500">Surgeon</p>
                          <p className="font-medium text-gray-900">{surgery.surgeon}</p>
                        </div>
                      </div>
                      {surgery.notes && (
                        <p className="mt-3 text-sm text-gray-700">{surgery.notes}</p>
                      )}
                    </div>
                  </div>
                </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-2 grid grid-cols-3 gap-4 text-sm">
                        <div>
                          ...
                          <p className="font-medium text-gray-900">
                            {new Date(immunization.date).toLocaleDateString('en-US', {
                              year: 'numeric',
                              month: 'short',
                              day: 'numeric',
                            })}
              ...
              {labResults.map((lab) => (
                <div key={lab.id} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3">
                        <h3 className="text-lg font-semibold text-gray-900">{lab.test}</h3>
                        <Badge
                          variant={
                            lab.status === 'normal'
                              ? 'success'
