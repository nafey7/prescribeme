              ...
              <div className="hidden md:flex items-center space-x-2">
                <Link to="/signup?role=doctor">
                  <Button
                    variant="primary"
                    size="md"
                    className="btn-gradient text-white text-xs px-3"
                  >
                    Doctor
                  </Button>
                </Link>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Streamline your healthcare workflow with our intuitive
                prescription management system. Designed for healthcare
                professionals who demand efficiency and security.
              </p>
              ...
              <div className="flex flex-col gap-6 mb-12">
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link to="/signup?role=doctor">
                    <Button
                      size="lg"
                      className="btn-gradient text-white px-8 w-full sm:w-auto"
                    >
                      I'm a Doctor
                    </Button>
                  </Link>
                  <Link to="/signup?role=patient">
                    <Button
                      size="lg"
                      variant="secondary"
                      className="px-8 w-full sm:w-auto border-2 border-primary-600 text-primary-600 hover:bg-primary-50"
                    >
                      I'm a Patient
                    </Button>
                  </Link>
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Powerful features designed to make prescription management simple
              and efficient
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl p-8 shadow-soft hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                HIPAA compliant with bank-level encryption. Your patient data is
                always protected.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-soft hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Optimized for speed. Access prescriptions instantly, no matter
                where you are.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-soft hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Access your prescriptions anywhere with our responsive web
                design.
              </p>
            </div>
        ...
        <div className="container-custom text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/signup?role=patient">
              <Button
                size="lg"
                className="bg-primary-700 text-white hover:bg-primary-600 border-white/20 px-8"
              >
                Sign up as Patient
              </Button>
            </Link>
